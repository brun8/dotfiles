...
local function set_keymaps()
  ...
  map('n', '<leader>1', ":lua require'harpoon.ui'.nav_file(1)<CR>", opt)
  map('n', '<leader>2', ":lua require'harpoon.ui'.nav_file(2)<CR>", opt)
  map('n', '<leader>3', ":lua require'harpoon.ui'.nav_file(3)<CR>", opt)
  map('n', '<leader>4', ":lua require'harpoon.ui'.nav_file(4)<CR>", opt)
